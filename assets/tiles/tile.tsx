...
<tileset version="1.5" tiledversion="1.7.0" name="tile" tilewidth="64" tileheight="32" tilecount="9" columns="1" objectalignment="top">
 <image source="tile.png" width="64" height="288"/>
 <tile id="5">
